...
const OpenViduMeetComponent = ({
    ...
    const [isAudioMuted, setIsAudioMuted] = useState(mode === "listen" || mode === "whisper");
    ...
    useEffect(() => {
        ...
        const connectToRoom = async () => {
            try {
                ...
                const shouldPublishAudio = mode === "barge" || mode === "whisper";
                ...
                if (shouldPublishAudio || shouldPublishVideo) {
                    ...
                    // Whisper: start mic muted so supervisor unmutes deliberately
                    if (mode === "whisper") {
